...
\restrict Nqg7Mdpg2sRCZ5dBVKnAjaBIEjk4GMD2lBoB9z9Pe2RW3Na4dv0g1RQ2h5x4vdz

-- Dumped from database version 18.0
-- Dumped by pg_dump version 18.0

-- Started on 2025-12-01 22:56:48
...
--
-- TOC entry 236 (class 1259 OID 90113)
-- Name: incoming_documents; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.incoming_documents (
    id integer NOT NULL,
    client_id integer NOT NULL,
    emitter_rut character varying(20) NOT NULL,
    emitter_name character varying(255),
    tipo_dte integer NOT NULL,
...
ALTER TABLE public.incoming_documents OWNER TO postgres;

--
-- TOC entry 235 (class 1259 OID 90112)
-- Name: incoming_documents_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.incoming_documents_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.incoming_documents_id_seq OWNER TO postgres;

--
-- TOC entry 5026 (class 0 OID 0)
-- Dependencies: 235
-- Name: incoming_documents_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.incoming_documents_id_seq OWNED BY public.incoming_documents.id;
...
--
-- TOC entry 4800 (class 2604 OID 57348)
...
--
-- TOC entry 4795 (class 2604 OID 49158)
...
--
-- TOC entry 4798 (class 2604 OID 49223)
...
--
-- TOC entry 4797 (class 2604 OID 49193)
...
--
-- TOC entry 4796 (class 2604 OID 49173)
...
--
-- TOC entry 4805 (class 2604 OID 90116)
-- Name: incoming_documents id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.incoming_documents ALTER COLUMN id SET DEFAULT nextval('public.incoming_documents_id_seq'::regclass);


--
-- TOC entry 4799 (class 2604 OID 49242)
...
--
-- TOC entry 4803 (class 2604 OID 81947)
...
--
-- TOC entry 4801 (class 2604 OID 81930)
...
--
-- TOC entry 5009 (class 0 OID 57345)
-- Dependencies: 230
...
--
-- TOC entry 4999 (class 0 OID 49155)
-- Dependencies: 220
...
--
-- TOC entry 5005 (class 0 OID 49220)
-- Dependencies: 226
...
--
-- TOC entry 5003 (class 0 OID 49190)
-- Dependencies: 224
...
--
-- TOC entry 5001 (class 0 OID 49170)
-- Dependencies: 222
...
--
-- TOC entry 5015 (class 0 OID 90113)
-- Dependencies: 236
-- Data for Name: incoming_documents; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.incoming_documents (id, client_id, emitter_rut, emitter_name, tipo_dte, folio, fecha_emision, monto_neto, monto_iva, monto_total, sii_state, raw_xml, created_at) FROM stdin;
\.


--
-- TOC entry 5007 (class 0 OID 49239)
-- Dependencies: 228
...
--
-- TOC entry 5013 (class 0 OID 81944)
-- Dependencies: 234
...
--
-- TOC entry 5011 (class 0 OID 81927)
-- Dependencies: 232
...
-- Dependencies: 235
-- Name: incoming_documents_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.incoming_documents_id_seq', 1, false);
...
--
-- TOC entry 4825 (class 2606 OID 57361)
...
--
-- TOC entry 4807 (class 2606 OID 49166)
...
--
-- TOC entry 4819 (class 2606 OID 49231)
...
--
-- TOC entry 4815 (class 2606 OID 49206)
...
--
-- TOC entry 4811 (class 2606 OID 49181)
...
--
-- TOC entry 4841 (class 2606 OID 90128)
-- Name: incoming_documents incoming_documents_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 4823 (class 2606 OID 49248)
...
--
-- TOC entry 4828 (class 2606 OID 57363)
...
--
-- TOC entry 4839 (class 2606 OID 81958)
...
--
-- TOC entry 4833 (class 2606 OID 81939)
...
--
-- TOC entry 4826 (class 1259 OID 57369)
...
--
-- TOC entry 4808 (class 1259 OID 49167)
...
--
-- TOC entry 4809 (class 1259 OID 49168)
...
--
-- TOC entry 4820 (class 1259 OID 49237)
...
--
-- TOC entry 4816 (class 1259 OID 49218)
...
--
-- TOC entry 4817 (class 1259 OID 49217)
...
--
-- TOC entry 4812 (class 1259 OID 49188)
...
--
-- TOC entry 4813 (class 1259 OID 49187)
...
--
-- TOC entry 4842 (class 1259 OID 90134)
-- Name: ix_incoming_documents_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_incoming_documents_id ON public.incoming_documents USING btree (id);


--
-- TOC entry 4821 (class 1259 OID 49259)
...
--
-- TOC entry 4834 (class 1259 OID 81959)
...
--
-- TOC entry 4835 (class 1259 OID 81961)
...
--
-- TOC entry 4836 (class 1259 OID 81962)
...
--
-- TOC entry 4837 (class 1259 OID 81960)
...
--
-- TOC entry 4829 (class 1259 OID 81941)
...
--
-- TOC entry 4830 (class 1259 OID 81940)
...
--
-- TOC entry 4849 (class 2606 OID 57364)
...
--
-- TOC entry 4846 (class 2606 OID 49232)
...
--
-- TOC entry 4844 (class 2606 OID 49207)
...
--
-- TOC entry 4845 (class 2606 OID 49212)
...
--
-- TOC entry 4843 (class 2606 OID 49182)
...
--
-- TOC entry 4850 (class 2606 OID 90129)
-- Name: incoming_documents incoming_documents_client_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.incoming_documents
    ADD CONSTRAINT incoming_documents_client_id_fkey FOREIGN KEY (client_id) REFERENCES public.clients(id);


--
-- TOC entry 4847 (class 2606 OID 49254)
...
--
-- TOC entry 4848 (class 2606 OID 49249)
...
-- Completed on 2025-12-01 22:56:48

--
-- PostgreSQL database dump complete
--

\unrestrict Nqg7Mdpg2sRCZ5dBVKnAjaBIEjk4GMD2lBoB9z9Pe2RW3Na4dv0g1RQ2h5x4vdz
